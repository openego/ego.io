...
class EgoRenewablePowerPlantsGermany(Base):
    __tablename__ = 'ego_renewable_power_plants_germany'
    __table_args__ = {'schema': 'supply'}
...
class SoetheWindPotentialArea(Base):
    __tablename__ = 'soethe_wind_potential_area'
    __table_args__ = {'schema': 'supply'}
