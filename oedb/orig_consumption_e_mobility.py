...
t_result_e_mobility_2020_2a_11001 = Table(
    ...
    Column('pause', SmallInteger),
    Column('driven_dist', Numeric(5, 2)),
    Column('swap', SmallInteger),
    Column('battery_state', Numeric(5, 2)),
    Column('load', Numeric(3, 2)),
    Column('swap_state', Numeric(5, 2)),
    Column('swap_load', Numeric(5, 2)),
    Column('real_swap', SmallInteger),
